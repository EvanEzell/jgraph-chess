...
void print_jgraph_board() {
    ...
    printf("no_grid_lines no_draw_hash_marks no_auto_hash_labels\n");
    ...
    printf("            printf(\"newline gray 1 poly ppattern estripe 45 pfill .8 pts \");\\\n");
    ...
    printf("newline pts 0 0 0 80 80 80 80 0 0 0\n\n");
}
